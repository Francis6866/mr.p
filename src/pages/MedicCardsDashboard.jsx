...
const CreatePatientModal = ({ isOpen, onClose, onPatientCreated }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.health_id.trim()) {
      newErrors.health_id = 'Health ID is required';
    }
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}  >
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">Create Medic Card</h2>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${errors.health_id ? 'border-red-500' : 'border-gray-300'
                }`}
              placeholder="Enter Health ID"
            />
            {errors.health_id && <p className="text-red-500 text-sm mt-1">{errors.health_id}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${errors.cardName ? 'border-red-500' : 'border-gray-300'
                }`}
            />
      ...
      <table className="w-full text-left text-sm">
        <thead>
          <tr className="bg-gray-50">
            ...
            <th className="p-3 font-semibold text-gray-600">View Card</th>
          </tr>
        </thead>
        <tbody>
          {currentPatients.length > 0 ? (
            currentPatients.map((patient, index) => (
              ...
              className={` cursor-pointer border-b border-gray-200 hover:bg-gray-50 ${selectedRows.has(patient.id) ? 'bg-blue-50' : ''}`}>
                ...
                <td className="p-3 text-gray-600">{patient.last_updated}</td>
                <td className="p-3 text-gray-600">{patient.age} years old</td>
                <td className={`p-3 text-gray-600 ${patient.status === 'Active' ? 'text-green-500' 
                : patient.status === 'Inactive' ? 'text-red-500' : 'text-yellow-500'}`}>{patient.status}</td>
                <td 
...
const MedicCardsDashboard = () => {
  const [isCreatePatientModalOpen, setIsCreatePatientModalOpen] = useState(false);
  const [patients, setPatients] = useState([
    { name: 'Brooklyn Simmons', gender: 'Male', dob: '1995-03-18', age: 29, department: 'Cardiology', id: 'OM123AA', status: 'Active', last_updated: '2000-03-21' },
    { name: 'Anthony Johnson', gender: 'Male', dob: '1997-03-18', age: 27, department: 'Cardiology', id: 'AT456BB', status: 'Pending', last_updated: '2002-05-28' },
    { name: 'Sarah Miller Olivia', gender: 'Female', dob: '1987-03-18', age: 35, department: 'Oncology', id: 'EA789CC', status: 'Pending', last_updated: '1995-06-18' },
    { name: 'Emily Davis', gender: 'Female', dob: '1990-05-12', age: 34, department: 'Neurology', id: 'ED101DD', status: 'Pending', last_updated: '2005-01-18' },
    { name: 'Michael Chen', gender: 'Male', dob: '1985-08-25', age: 39, department: 'Orthopedics', id: 'MC202EE', status: 'Pending', last_updated: '1995-08-18' },
    { name: 'Lisa Rodriguez', gender: 'Female', dob: '1992-11-03', age: 32, department: 'Cardiology', id: 'LR303FF', status: 'Active', last_updated: '2002-03-01' },
    { name: 'David Wilson', gender: 'Male', dob: '1988-12-15', age: 36, department: 'Neurology', id: 'DW404GG', status: 'Active', last_updated: '1998-10-12' },
    { name: 'Jennifer Brown', gender: 'Female', dob: '1993-07-22', age: 31, department: 'Orthopedics', id: 'JB505HH', status: 'Pending', last_updated: '2003-06-01' },
    { name: 'Robert Taylor', gender: 'Male', dob: '1986-04-08', age: 38, department: 'Cardiology', id: 'RT606II', status: 'Inactive', last_updated: '2006-05-18' },
    { name: 'Amanda Garcia', gender: 'Female', dob: '1991-09-30', age: 33, department: 'Oncology', id: 'AG707JJ', status: 'Inactive', last_updated: '2015-03-22' },
  ]);
...
export default MedicCardsDashboard;